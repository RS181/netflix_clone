...
//                    Toast.makeText(getBaseContext(),textPass.getText().toString() + "/" + textVerPass.getText().toString().toString(), LENGTH_SHORT).show();
                if (check && !textUser.toString().equals(" ") && !textPass.toString().equals(" ") && !textVerPass.toString().equals(" ")) {
                    progressBar.setVisibility(View.VISIBLE);
                    ...
                    Call<Post> call = jsonPlaceHolderApi.NewNormalUser(post);
                    ...
                    call.enqueue(new Callback<Post>() {
                        ...
                        public void onResponse(Call<Post> call, Response<Post> response) {
                            ...
                            if (response.isSuccessful()) {
                                Toast.makeText(getBaseContext(), "REGISTADO NEW USER", LENGTH_SHORT).show();
