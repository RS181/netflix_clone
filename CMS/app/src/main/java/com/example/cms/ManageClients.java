...
public class ManageClients extends AppCompatActivity {
    ...
    private View view;
    private CustomListViewClients customlistview;
    ...
    public void getAdminsList(){
        ...
        Call<List <Post>> call = jsonPlaceHolderApi.getClientsList();
        call.enqueue(new Callback<List<Post>>() {
            ...
            public void onResponse(Call<List<Post>> call, Response<List<Post>> response) {
                if (response.isSuccessful()) {
                    ...
                    customlistview = new CustomListViewClients(getBaseContext(),itemlist);
