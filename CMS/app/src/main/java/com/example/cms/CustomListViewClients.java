...
public class CustomListViewClients extends BaseAdapter {
    Context context;
    private List<Map<String,String>> list = new ArrayList<>();
    LayoutInflater inflater;

    public CustomListViewClients(Context ctx, List<Map<String,String>> list){
        this.context = ctx;
        this.list = list;
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        textView2.setText("User : " + (String) list.get(i).get("User"));
    ...
    private void onRemoveButtonClick(int position) throws JSONException {
        ...
        String aux = (String) list.get(position).get("User");
        ...
        Call<Post> call = jsonPlaceHolderApi.removeClients(body);
